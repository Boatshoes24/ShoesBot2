...
const { bosses, num_bosses } = require("./aberrus.json")
const spaceChar = '\u200B'
const commandName = "aberrus"
...
function formatEmbedArgs(args) {
    ...
    if (!args.length) {
        ...
        embedFields.push({ name: 'All Auras', value: `!${commandName} all\nAuras: ${auraTotalCount}`, inline: false})
...
module.exports = {
    ...
    cooldown: 1,
    execute(msg, args) {
        let title = 'Aberrus Auras'       
        
        const vaultEmbed = new Discord.MessageEmbed()
        .setTitle(title)
        .setThumbnail('https://dotesports.com/wp-content/uploads/2023/03/WoW-Aberrus-the-Shadowed-Crucible.jpg')
        .setTimestamp()
        .setFooter({ 
